...
--These errors were found by using the following query and substituting in Site, Station, City, State, and Country everywhere 'Country' is found:
...
--SET Location = 'Launch Platform, Shahrud Missile Test Site, Iran'
--WHERE Location = 'Launch Plateform, Shahrud Missile Test Site'

--UPDATE space_missions
--SET Location = 'Vertical Launch Area, Spaceport America, New Mexico, USA'
--WHERE Location = 'Vertical Launch Area, Spaceport America, New Mexico'

--UPDATE space_missions
--SET Location = 'LP-41, Pacific Missile Range Facility, Hawaii, USA'
--WHERE Location = 'LP-41, Kauai, Pacific Missile Range Facility'

--The following query is used to verify that UPDATE excecuted successfully. Can edit the text after LIKE to check each UPDATE.
SELECT Location
FROM space_missions
WHERE Location LIKE '%Shahrud%';
